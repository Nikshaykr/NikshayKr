...
ROWS = [
    ("host",),
    ("kv", "Now", "Java Backend Dev"),
    ("kv", "Edu", "BCA '26 @ Gagan College"),
    ("kv", "Focus", "Spring Boot & REST APIs"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Lang", "Core Java, SQL"),
    ("kv", "Framework", "Spring Boot 3, JWT"),
    ("kv", "Database", "MySQL 8.0"),
    ("kv", "Tools", "Git, Maven, Postman"),
    ("kv", "Testing", "JUnit 5"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built secure Job Portal REST API"),
    ("bul", "Solving the NeetCode 150 DSA set"),
]
